...
%>  
   ...
   <div id='calendar-container'>
      ...
      <div id="calendar" class="fc fc-media-screen fc-direction-ltr fc-theme-standard" style="height: 700px;">
   ...
   <script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script type="text/javascript">
      /*   let loadCal = function(calendar){
            ...
            let userid = $('div[id=aa]').val();//사용자가 로그인한 아디값
           //=======ajax데이터 불러올 부분====
              $.ajax({
                  url : "GetDate.do",
               type : "get",
               ...
               dataType : 'json', // 데이터 타입을 지정 안하면 기본값인 String 으로 가져옴 꼭 json으로 지정해줘야한다
