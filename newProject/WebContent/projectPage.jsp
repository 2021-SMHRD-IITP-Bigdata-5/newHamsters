...
%>
  ...
  <!---------------------------------------- 가입확인 ------------------------------------------->
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
                ...
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;"><%=ttmem.getMemId() %>님은</span></p>
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;"><%=t_DTO.getTeamName() %>팀에 가입 대기 중 입니다</span></p>
                <p style="text-align: center; line-height: 1.5;"><b><span style="color: rgb(255, 0, 0); font-size: 14pt;">'가입 수락' 버튼</span></b></p>
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;">을 누르신 후에 게시물을 확인할 수 있습니다</span></p>
                ...
                <p style="text-align: center; line-height: 1.5;"><br /></p>
                <p><br /></p>
            <button type="submit" style="cursor:pointer;background-color:#DDDDDD;text-align:">가입수락</button>
      </div>
    </div>
 </form>
        <!--End Modal-->
 ...
 <script src="https://code.jquery.com/jquery-latest.js"></script> 
    <script type="text/javascript">
      <%if(ttmem.getTmMemo().equals("가입 대기 중")){%>
...
<div class="container-scroller">
  ...
  <div id="modal" class="modal_content">
        <div class="modal_content">
            ...
            <div class="content">
                ...
                <br>
                <div id="button">
                    <button id="submit" type="submit" style="border:0 solid black">만들기</button>
                </div>
  ...
  <div id="modal1" class="modal_content">
        <div class="modal_content">
            ...
            <div class="content">
                <input type = "text" name ="title" id="title" placeholder="제목을 입력하세요."><br><br>
                <input type = "text" name ="content" id="content" placeholder="내용을 입력하세요." style="border:0 solid black"><br>
                <input type = "text" name ="hashtag" id="hashtag" placeholder="해쉬태그" style="border:0 solid black">
                <br><br>
                <br><br>
                <div id="button">
